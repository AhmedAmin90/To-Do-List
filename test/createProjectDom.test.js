...
import {projectsArray, setProjects} from '../src/createProject'
...
describe('Test Project Dom file' , ()=> {
  ...
  test('Load Tasks' , ()=> {
    ...
    document.body.innerHTML =
       ...
       `
    loadTasks(0);
      const taskMainDiv = document.querySelector('.task-box');
      const taskCardHeader = document.querySelector('.card-header');
      const taskCardDiv = document.querySelector('.card-body');
      const taskCardTitle = document.querySelector('.card-body h1');
      const taskCardDescription = document.querySelector('.card-body :nth-child(2)');
      const taskCardDate = document.querySelector('.card-body :nth-child(3)');
